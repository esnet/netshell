package org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.netshell.odlmdsal.impl.rev150807 ;
...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "netshell-odlmdsal-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:netshell-odlmdsal:impl";
    private final String revision = "2015-08-07";
    private final String resourcePath = "/META-INF/yang/netshell-odlmdsal-impl.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.netshell.odlmdsal.rev150807.$YangModuleInfoImpl.getInstance());
