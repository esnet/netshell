package org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.netshell.odlmdsal.rev150807 ;
...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "netshell-odlmdsal";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:netshell-odlmdsal";
    private final String revision = "2015-08-07";
    private final String resourcePath = "/META-INF/yang/netshell-odlmdsal.yang";
